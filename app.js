...
document.addEventListener("DOMContentLoaded", async () => {
  const currentVersion = window.APP_VERSION || "v2.2.14";
  ...
  try {
    ...
    // Register Retrieve Publisher Logo form and auto-retrieve handlers
    ...
    if (deletePlatformForm) {
      deletePlatformForm.addEventListener("submit", handleDeletePlatformSubmit);
    }
